      ...
      <div className="mt-8">
        <Card className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <button className="bg-green-500 hover:bg-green-600 text-white font-bold py-3 px-6 rounded-lg shadow-md transition-all">
              Manage Events
            </button>
            <button className="bg-yellow-500 hover:bg-yellow-600 text-white font-bold py-3 px-6 rounded-lg shadow-md transition-all">
              View Enquiries
            </button>
          </div>
        </Card>
