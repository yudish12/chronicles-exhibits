...
<div className="px-4 sm:px-20 py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
  {locations.data.map((city, index) => (
    ...
    >
      <div
        className="relative bg-white border border-gray-300 rounded-3xl shadow-lg transition-all duration-300 hover:shadow-2xl hover:scale-105 p-8 text-center flex flex-col items-center gap-4"
      >
