      ...
      <div className=" flex items-center justify-center bg-white px-10  ">
        <div className="container py-12 px-10 lg:px-24">
          ...
          <p className="text-lg mb-8">
            Chronicle Exhibits (&quot;Chronicle,&quot; &quot;we,&quot;
            &quot;us,&quot; or &quot;our&quot;) is committed to protecting the
            privacy of our users (&quot;you&quot; or &quot;your&quot;). This
          ...
          <section className="gap-y-8">
            ...
            <div>
              ...
              <p className="leading-relaxed py-2">
                ...
                when you register for an account, subscribe to our newsletter,
                or contact us. Usage Data: We may also collect information about
                your use of our website, such as the pages you visit, the links
                you click, and the searches you conduct. This data is collected
                anonymously and does not identify you personally.
              </p>
            </div>
            ...
            <div>
              ...
              <p className=" leading-relaxed py-2">
                ...
                who help us operate our website and conduct our business. These
              ...
              <p className="py-2 leading-relaxed">
                ...
                advertisers or marketing companies without your consent.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="py-2 leading-relaxed mb-6 ">
                ...
                contact us by email at [enquiry@triumfous]
              </p>
            </div>
          </section>
        </div>
