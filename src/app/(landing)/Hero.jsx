...
const Hero = ({ fields }) => {
  return (
    <div className="lg:h-[100vh]  sm:h-[40vh] h-full">
      ...
      <div className="left-[20%] lg:p-8 p-4 rounded-[32px] justify-center lg:absolute flex flex-col gap-8 lg:w-[60%] w-full  bg-white top-[59%] lg:mt-16 sm:mt-8 mt-0">
