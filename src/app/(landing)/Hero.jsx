...
const Hero = ({ fields }) => {
  return (
    <div className="xl:h-[95vh] lg:h-[100vh] relative 2xl:h-[64vh] h-full">
      ...
      <div className="left-[20%] px-6 sm:px-12 md:px-20 lg:p-8 p-4 rounded-[32px] justify-center lg:absolute flex flex-col gap-8 lg:w-[60%] w-full  bg-white top-[43%] 2xl:bottom-12 lg:mt-16 sm:mt-4 mt-0">
        <h3 className="text-2xl sm:text-3xl text-wrap 2xl:mt-8 break-words text-center text-primary uppercase font-medium">
          {fields[3].value}
        </h3>
