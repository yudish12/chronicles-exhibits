        ...
        <div className="left-[20%] px-6 sm:px-12 md:px-20 lg:p-8 p-4 rounded-[32px] justify-center lg:absolute flex flex-col gap-8 lg:w-[60%] w-full bg-white top-[43%] 2xl:top-[47%] lg:mt-16 sm:mt-4 mt-0">
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button
                style={{ transitionDuration: "500ms" }}
                className="rounded-full w-1/6 font-semibold mx-auto px-6 py-5 bg-primary body-bold text-base  hover:bg-white hover:text-secondary border-2 border-secondary text-secondary"
              >
                Get Quote
              </Button>
            </DialogTrigger>
