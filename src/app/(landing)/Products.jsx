...
const Products = () => {
  ...
  const cards = [
    {
      imgSrc: "/what-we-do-1.png",
      size: "10X10 trade show booth rental",
      link: "#",
    },
    {
      imgSrc: "/what-we-do-1.png",
      size: "10X20 trade show booth rental",
      link: "#",
    },
    {
      imgSrc: "/what-we-do-1.png",
      size: "10X30 trade show booth rental",
      link: "#",
    },
    {
      imgSrc: "/what-we-do-2.png",
      size: "20X20 trade show booth rental",
      link: "#",
    },
    {
      imgSrc: "/what-we-do-2.png",
      size: "20X30 trade show booth rental",
      link: "#",
    },
    {
      imgSrc: "/what-we-do-2.png",
      size: "30X30 trade show booth rental",
      link: "#",
    },
    {
      imgSrc: "/what-we-do-3.png",
      size: "40X40 trade show booth rental",
      link: "#",
    },
    {
      imgSrc: "/what-we-do-3.png",
      size: "40X50 trade show booth rental",
      link: "#",
    },
    {
      imgSrc: "/what-we-do-2.png",
      size: "50X50 trade show booth rental",
      link: "#",
    },
  ];
  ...
  const handleNext = () => {
    setActiveIndex((prevIndex) => (prevIndex + visibleCards) % cards.length);
  };
      ...
      <div className="flex items-center justify-center w-full px-32 pt-6 relative my-6">
        ...
        <div className="flex justify-center items-center gap-12 overflow-hidden">
          {cards.map((item, index) => (
            <div
              key={index}
              className={`transition-all transform h-[370px] w-[370px] ${
                index >= activeIndex && index < activeIndex + visibleCards
                  ? "scale-100 opacity-100 block"
                  : "scale-0 opacity-0 hidden"
              }`}
            >
              <div className="rounded-lg shadow-one  overflow-hidden w-[100%] h-[98.75%] bg-secondary flex flex-col">
                {/* Image Section */}
                <img
                  src={item.imgSrc}
                  alt={item.size}
                ...
                <div className="flex flex-col justify-center items-center bg-secondary/[.94] text-white h-[25%]">
                  <div className="text-xl font-bold  text-white heading-font pt-2">
                    {item.size}
                  </div>
                  <Link
                    href={item.link}
