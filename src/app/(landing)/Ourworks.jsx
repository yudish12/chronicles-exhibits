...
const Ourworks = () => {
  return (
    <div className="flex flex-col px-4 sm:px-8 md:px-12 py-4 gap-6">
      <h3
        style={{ lineHeight: "1.2" }}
        className="text-xl sm:text-2xl md:text-[2rem] text-secondary heading-font font-semibold text-center"
      >
        TRADE SHOW BOOTH DESIGN PORTFOLIO
      </h3>
      <p className="text-sm sm:text-base md:text-lg text-black text-center mb-2 px-4 sm:px-8 md:px-16">
