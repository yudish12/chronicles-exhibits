    ...
    <>
      ...
      <div className="flex flex-col justify-center items-center h-screen overflow-hidden">
        ...
        <div className="text-center flex flex-col items-center justify-center px-4">
          <p>You're one step closer to a smooth and successful exhibition!</p>
          <p>Your request has been successfully submitted. Our team will connect with you shortly.</p>
        </div>
        <div className="mt-6 ">
